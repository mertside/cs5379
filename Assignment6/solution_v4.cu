...
int main(int argc, char **argv)
{
  ...
  // memcopies to GPU
  CUDA_RT_CALL(cudaMemcpy(d_D, h_D, n * sizeof(int*), cudaMemcpyHostToDevice));
  ...
  CUDA_RT_CALL(cudaMemcpy(h_D, d_D, n * sizeof(int*), cudaMemcpyDeviceToHost));
